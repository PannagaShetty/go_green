...
const double efEleValue = 0.432;
const double efWaterValue = 0.00059;
const double efLpgValue = 5.68 / 4.154;
const double efWasteValue = 2.5;
const double efWetWasteValue = 2.25;
const double efBikeValue = 0.230;
const double efBusValue = 0.1;
const double efCarValue = 0.130;
const double efRailValue = 0.041;
const double efAeroplaneValue = 0.113;
const double efMeatValue = 5;
const double efDairyValue = 1.5;
const double efVegetableValue = 2.5;
const double efFruitsValue = 0.75;
const double efSnacksValue = 1.5;
const double efDrinksValue = 0.020;
const double efGrainsValue = 0.7;
const double efElectricalValue = 0;
const double efMedicalValue = 0;
const double efClothingValue = 0;
const double efHouseholdValue = 0;
